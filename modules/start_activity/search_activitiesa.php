								...
								<table class="table table-striped">
									<tbody>
										<tr>
											...
											<td><b><?php $ground_id = $row['training_ground'];
											...
											<td><?php $sqla = "SELECT count(participant_id) as parts FROM field_participants WHERE training =$id";
												$resulta = mysqli_query($dbcon, $sqla);
										...
										<tr>
											<td><?php $sqla = "SELECT count(participant_id) as me1 FROM me_f1 WHERE training_id=$id";
												$resulta = mysqli_query($dbcon, $sqla);
