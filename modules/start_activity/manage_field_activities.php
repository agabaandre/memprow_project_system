...
?>
 ...
 <div class="col-md-3">
                 ...
                 <input type="text" class="form-control" name="mytraining" value="<?php if (($_POST['mytraining'])!="") { echo $activity=$_POST['mytraining'];}?>">
				</div>
				...
				<div class="input-group date" data-provide="datepicker">
                      ...
                      <input name="start" placeholder="From"  type="text" id="test1"   class="form-control" value="<?php if (($_POST['start'])!="") { echo $start=date("Y/m/d",strtotime($_POST['start'])); } ?>" />
			       ...
			       <label>Start date (To):  <span style="color:red">*</span></label>
					<div class="input-group date" data-provide="datepicker">
                      ...
                      <input name="end"  type="text" id="test1" placeholder="To"   class="form-control" value="<?php if (($_POST['end'])!="") { echo $start=date("Y/m/d",strtotime($_POST['end'])); } ?>" />
                      <span class="input-group-addon">
                      <i class="glyphicon glyphicon-th"></i>
 ...
 // start count paging
   include("modules/universal_funcs/paging_class.php");
	...
	?>
				  ...
				  $activity=$_POST['mytraining'];
				   ...
				   <tr>
					...
					<td><a href="dashboard.php?action=attach_participants&training=<?php echo $training;?>">Add Participants(s)</a> |
					  <a href="dashboard.php?action=finish&training=<?php echo $training;?>">View / Remove Participants(s)</a></td>
                                    ...
                                    <div class="modal-dialog modal-sm" style="margin-top:10%;"">
                                      <div class="modal-content">
                                          <div class="modal-header">
                                              ...
                                              <h4 class="modal-title"><center><i class=""></i>Select Tools to use</center></h4>
                                          </div>
         ...
         <div id="">
					<table>
				   <tr><td> <label class="btn btn-sm btn-default" >PRE SRHR:
					  ...
					  <div class="modal fade" id="upload<?php echo $id;?>" tabindex="-1" role="dialog" data-backdrop="static">
                                    <div class="modal-dialog">
                                      <div class="modal-content">
                                          <div class="modal-header">
                                              <button aria-hidden="true" data-dismiss="modal" class="close" type="button">&times;</button>
                                              <h4 class="modal-title"><center><i class=""></i>Upload / Update Activity Report</center></h4>
                                          </div>
                                          <div class="modal-body">
			...
			<div class="modal fade" id="<?php echo $modalid;?>" tabindex="-1" role="dialog" data-backdrop="static">
                                    <div class="modal-dialog">
                                      <div class="modal-content">
                                          <div class="modal-header">
                                              <button aria-hidden="true" data-dismiss="modal" class="close" type="button">&times;</button>
                                              <h4 class="modal-title"><center><i class=""></i>Update activities</center></h4>
                                          </div>
                                          <div class="modal-body">
           ...
           <form name="" id="data_form" method="post" action="">
				   <div id="">
					...
					<label>Start date:  <span style="color:red">*</span></label>
                      <input name="startdate"  type="text" id="test1"   class="form-control" value="<?php if ($row['start_date']!="0000-00-00"){ echo $row['start_date'];}?>" required>
					...
					<label>End date:  <span style="color:red">*</span></label>
                      <input name="enddate"  type="text" id="test1"   class="form-control" value="<?php if ($row['end_date']!="0000-00-00"){ echo $row['end_date'];}?>" required>
                      <div class="input-group-addon">
                      <span class="glyphicon glyphicon-th"></span>
                     </div>
			        </div>
                        ...
                        <select class="form-control select2" name="activity_id" id="activity_id myselect" style="width:100%;">
                          <?php
							$sql2 = mysqli_query($dbcon,"SELECT * FROM activities");
							  ...
							  {
							  $i2++; ?>
							  <option value="<?php echo $select_op=$list2['activity_id']; ?>"<?php if ($select_op==$act_id){echo "selected";}?>><?php  echo $list2['activity']; ?>
							  </option>
		               <?php } ?>
				      </select>
                        ...
                        <select class="form-control select2" name="supervisor" id="activity_id myselect" style="width:100%;">
                          <?php
							$sql2 = mysqli_query($dbcon,"SELECT * FROM supervisors");
							  ...
							  {
							  $i2++; ?>
							  <option value="<?php echo $select_op=$list2['supervisor_id']; ?>"<?php if ($select_op==$sp_id){echo "selected";}?>><?php  echo $list2['surname']." ".$list2['firstname']." ".$list2['othername']; ?>
							  </option>
		               <?php } ?>
				      </select>
					</div>
                        ...
                        <select class="form-control select2" name="training_ground" id="training_ground myselect" style="width:100%;">
                          <?php
							$sql2 = mysqli_query($dbcon,"SELECT * FROM grounds");
							  ...
							  {
							  $i2++; ?>
							  <option value="<?php echo $select_op=$list2['ground_id']; ?>"<?php if ($select_op==$gid){echo "selected";}?>><?php  echo $list2['ground']; ?>
							  </option>
		               <?php } ?>
				      </select>
					</div>
				      ...
				      <select class="form-control select2" name="location" id="location myselect" style="width:100%;">
                          <?php
							$sql1 = mysqli_query($dbcon,"SELECT * FROM district");
							  ...
							  {
							  $i1++; ?>
					          <option value="<?php echo $select_op=$list1['district_id']; ?>"<?php if ($select_op==$did){echo "selected";}?>><?php  echo $list1['name']; ?>
							  </option>
		               <?php } ?>
				      </select>
			       </div>
