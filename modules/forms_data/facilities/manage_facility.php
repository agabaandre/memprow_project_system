<div class="col-md-12">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">
            <center><i class="fa fa-user fa-spin"></i>Add Facility</center>
          </h4>
        </div>
  ...
  if (isset($_POST['delete'])) {
    ...
    if ($rs_id != "") {
      ...
      if ($act = mysqli_query($dbcon, "Delete from facility where facility_id='$rs_id'")) {
  ...
  <?php if (isset($_POST['update'])) {
    ...
    if ($rs_id != "") {
      ...
      if ($act = mysqli_query($dbcon, "UPDATE `attendance_tracking`.`facility` SET `name` = '$value',`type` = '$type' WHERE `facility`.`facility_id` ='$rs_id'")) {
  ...
  <?php if (isset($_POST['add'])) {
    ...
    $value = $_POST['facility'];
    $type = $_POST['type'];
    $counts = mysqli_query($dbcon, "select * from  facility where name='$value'");
    ...
    if (count($row) == 1) {
      ...
      if ($act = mysqli_query($dbcon, " INSERT INTO `attendance_tracking`.`facility` (
`facility_id` ,
`name`,
`type`
)
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <button aria-hidden="true" data-dismiss="modal" class="close" type="button">&times;</button>
                      <h4 class="modal-title">
                        <center><i class="fa fa-user fa-spin"></i>Update Facility</center>
                      </h4>
                    </div>
                    <div class="modal-body">
