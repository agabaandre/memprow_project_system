	...
	<div id="">
		           ...
		           <label>Select Participant:  <span style="color:red"></span></label> 
                        <select class="form-control select2" name="activity_id" id="activity_id myselect" style="width:100%;" required>
                          <?php 
							$sqlp = mysqli_query($dbcon,"SELECT * FROM participants");
		                   
							  while ($listp=mysqli_fetch_array($sqlp))
							  {
							 ?>
							  <option value="<?php echo $listp['participant_id']; ?>"><?php echo $myname=$listp['surname']." ".$listp['firstname']." ".$listp['othername'];?>
							  </option>
		               <?php } ?>
				      </select>
	</div>
...
<form action="" method="post">
				<div id="">
                   ...
                   <div id="">
                    ...
                    <tr>
					  ...
					  <td><input  name="gender" id="" value="Male" type="radio"  <?php if ($value=='value'){ echo 'checked';}?>></td>   				  
					  <td><input  name="gender" id="" value="Male" type="radio"  <?php if ($value=='value'){ echo 'checked';}?>></td>   				  
					  <td><input  name="gender" id="" value="Male" type="radio"  <?php if ($value=='value'){ echo 'checked';}?>></td>   				  
					  <td><input  name="gender" id="" value="Male" type="radio"  <?php if ($value=='value'){ echo 'checked';}?>></td>   				  
					  <td><input  name="gender" id="" value="Male" type="radio"  <?php if ($value=='value'){ echo 'checked';}?>></td>
               ...
               <div id="">
                    ...
                    <tr>
					  ...
					  <td><input  name="gender_issues_understanding" id="" value="Male" type="radio"  <?php if ($value=='value'){ echo 'checked';}?>></td>   				  
					  <td><input  name="gender_issues_understanding" id="" value="Male" type="radio"  <?php if ($value=='value'){ echo 'checked';}?>></td>   				  
					  <td><input  name="gender_issues_understanding" id="" value="Male" type="radio"  <?php if ($value=='value'){ echo 'checked';}?>></td>   				  
					  <td><input  name="gender_issues_understanding" id="" value="Male" type="radio"  <?php if ($value=='value'){ echo 'checked';}?>></td>   				  
					  <td><input  name="gender_issues_understanding" id="" value="Male" type="radio"  <?php if ($value=='value'){ echo 'checked';}?>></td>
